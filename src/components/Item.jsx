...
const Item = ({ itemData }) => {
    ...
    return (
        <div className="bg-fh_white flex align-middle flex-row justify-evenly min-h-screen p-6">
                ...
                <div className="flex m-2">
                    {itemData.images.map((image, index) => {
                        return <img
                            ...
                            className='w-40 h-auto hover:brightness-75 transition duration-300 rounded-md m-2'
                        />
                    })}
                </div>
            </div>
...
// id, userId, name, description, category, location, priceRange, date_publish, images